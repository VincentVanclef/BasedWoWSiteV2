  ...
  >
    <b-container class="font-weight-bold">
      <b-form-group>
        ...
        ></date-picker>
        <b-tooltip v-if="errors.has('ban-duration')" placement="bottom" target="ban-duration">{{ getErrorMsg('ban-duration') }}</b-tooltip>
      </b-form-group>
      <b-form-group>
        <label>Reason</label>
        <b-textarea
        ...
        ></b-textarea>
        <b-tooltip v-if="errors.has('ban-duration')" placement="bottom" target="ban-reason">{{ getErrorMsg('ban-reason') }}</b-tooltip>
      </b-form-group>
    </b-container>
  </b-modal>
</template>
