  ...
  <div class="container">
    <section class="body">
      <p>
        ...
        <br>
        By accessing or using www.{{ServerName}}.org (the "site") and its services (the "services"), you (the "user") agree to comply with the terms and conditions governing the user's use of any areas of the site and affiliated services as set forth below.
      </p>
      <p>&nbsp;</p>
      <p>
      ...
      <p>&nbsp;</p>
      <p>
        <strong>Site Account</strong>
        <br>The user may register a regular account and password for the service for free. you are responsible for all activity under your account, associated accounts, and passwords. the site is not responsible for unauthorised access to your account, and any loss of virtual items associated with it.
      </p>
      <p>&nbsp;</p>
      <p>
        <strong>Events, Videos and Community Creations</strong>
        <br>Upon registering an account, you agree that your account or characters may be included in any events, streams or videos for promotion or review purposes.
      </p>
      <p>&nbsp;</p>
      <p>
        <strong>Access to the site and services</strong>
        <br>
        {{ ServerName }} provides free and unlimited access to the site and the services.
      </p>
      <p>&nbsp;</p>
      <p>
